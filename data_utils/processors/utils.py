...
class InputFeatures(object):
    """
    A single set of features of data_utils.
    ...
    def __init__(self, input_ids, attention_mask=None, token_type_ids=None, label=None,
                 example_id=None, element_type_ids=None):
        self.example_id = example_id
        self.input_ids = input_ids
        self.attention_mask = attention_mask
        self.token_type_ids = token_type_ids
        self.element_type_ids = element_type_ids
        self.label = label
...
class DataProcessor(object):
    """Base class for data_utils converters for sequence classification data_utils sets."""
...
class SingleSentenceClassificationProcessor(DataProcessor):
    """ Generic processor for a single sentence classification data_utils set."""
