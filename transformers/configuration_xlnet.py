...
XLNET_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "xlnetpath-clm-ace": "conf/ace/xlnetpath-clm-ace-config.json",
    "xlnetpath-clmnsp-ace": "conf/ace/xlnetpath-clmnsp-ace-config.json",
    "xlnetpath-clm-acefine": "conf/ace.fine/xlnetpath-clm-ace-config.json",
    "xlnetpath-clm-covid": "conf/covid/xlnetpath-clm-covid-config.json",
    "xlnet-base-cased": "conf/xlnet/xlnet-base-cased-config.json",
