...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        print('mixed_query_layer', mixed_query_layer)
        ...
        print('self attention output', outputs)
        return outputs
...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        print('self_attention_outputs', self_attention_outputs)
        attention_output = self_attention_outputs[0]
        print('attention_output', attention_output)
        outputs = self_attention_outputs[1:]  # add self attentions if we output attention weights
        print('end attention', outputs)
...
class BertForPreTraining(BertPreTrainedModel):
    ...
    def forward(
        ...
        if masked_lm_labels is not None and next_sentence_label is not None:
            ...
            outputs = (total_loss,) + outputs + (masked_lm_loss, next_sentence_loss) # added by lim: append the individual loss at the end
