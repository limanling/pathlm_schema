...
class PreTrainedTokenizer(SpecialTokensMixin):
    ...
    def encode_plus(
        ...
        return_element_type_ids: Optional[bool] = None,
        ...
        **kwargs
        ...
        return self.prepare_for_model(
            ...
            return_element_type_ids=return_element_type_ids,
    ...
    def prepare_for_model(
        ...
        if return_element_type_ids is None:
            return_element_type_ids = "element_type_ids" in self.model_input_names
        ...
        if add_special_tokens:
            ...
            element_type_ids = self.create_element_type_ids_from_sequences(ids, pair_ids)
        else:
            sequence = ids + pair_ids if pair else ids
            token_type_ids = [0] * len(ids) + ([1] * len(pair_ids) if pair else [])
            # generate element_type_ids
            element_type_ids = []
            for i in range(len(ids)):
                if i % 2 == 0:
                    element_type_ids.append(1)
                else:
                    element_type_ids.append(2)
            if pair:
        ...
        if return_element_type_ids:
            encoded_inputs["element_type_ids"] = element_type_ids
        ...
        if needs_to_be_padded:
            ...
            if self.padding_side == "right":
                ...
                if return_element_type_ids:
                    encoded_inputs["element_type_ids"] = (
                        encoded_inputs["element_type_ids"] + [self.pad_token_id] * difference
                    )
                if return_special_tokens_mask:
                ...
                if return_element_type_ids:
                    encoded_inputs["element_type_ids"] = [self.pad_token_id] * difference + encoded_inputs[
                        "element_type_ids"
                    ]
                if return_special_tokens_mask:
        ...
        if return_tensors == "tf" and is_tf_available():
            ...
            if "element_type_ids" in encoded_inputs:
                encoded_inputs["element_type_ids"] = tf.constant([encoded_inputs["element_type_ids"]])
            ...
            if "element_type_ids" in encoded_inputs:
                encoded_inputs["element_type_ids"] = torch.tensor([encoded_inputs["element_type_ids"]])
...
class PreTrainedTokenizerFast(PreTrainedTokenizer):
    ...
    def _convert_encoding(
        ...
        for e in encodings:
            ...
            if return_element_type_ids:
                encoding_dict["element_type_ids"].append(e.element_type_ids)
            if return_attention_mask:
